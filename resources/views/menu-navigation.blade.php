@if (Workup\MenuBuilder\MenuBuilder::getResourceClass()::authorizedToViewAny(request()))
    <router-link tag="a" :to="{ name: 'menus' }"
        ...
        <svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor">
            <path fill="var(--sidebar-icon)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
